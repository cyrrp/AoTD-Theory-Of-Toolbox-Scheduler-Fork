...
$releaseTimestamp = [DateTimeOffset]::new(2026, 8, 17, 0, 0, 0, [TimeSpan]::Zero)
...
if ($prepatcherDependency.Count -ne 1 -or $prepatcherDependency[0].version -cne '0.18.3') {
    throw "Scheduler Fork 1.0.14-spp13 requires exactly one Prepatcher dependency at version 0.18.3."
}
