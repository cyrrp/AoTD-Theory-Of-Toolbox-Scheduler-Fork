 ...
 *
 * <p>The dirty mask answers which work is queued. The domain revision vector
 * answers whether a captured result is still causally valid. Keeping these two
 * responsibilities separate prevents unrelated trade/accessibility events from
 * invalidating price work.</p>
 */
public final class MarketEconomyState {
    ...
    public long getStructureRevision() { return structureRevision; }
    public long getMaterializedRevision() { return materializedRevision; }
    public long getPriceInputRevision() { return priceInputRevision; }
    public long getStockpileRevision() { return stockpileRevision; }
    public long getAccessibilityRevision() { return accessibilityRevision; }
    public long getTradeInputRevision() { return tradeInputRevision; }
    public long getTemporalRevision() { return temporalRevision; }

    public long getMaterializedCommittedStructureRevision() {
        return materializedCommittedStructureRevision;
    }
    public long getMaterializedCommittedRevision() { return materializedCommittedRevision; }
    ...
    public long getPriceCommittedInputRevision() { return priceCommittedInputRevision; }
    public long getPriceCommittedStockpileRevision() { return priceCommittedStockpileRevision; }
    public long getPriceCommittedTemporalRevision() { return priceCommittedTemporalRevision; }
    ...
    public long getTradeCommittedInputRevision() { return tradeCommittedInputRevision; }
    public long getTradeCommittedTemporalRevision() { return tradeCommittedTemporalRevision; }
    ...
    void setStructureRevision(long value) { structureRevision = value; }
    void setMaterializedRevision(long value) { materializedRevision = value; }
    void setPriceInputRevision(long value) { priceInputRevision = value; }
    void setStockpileRevision(long value) { stockpileRevision = value; }
    void setAccessibilityRevision(long value) { accessibilityRevision = value; }
    void setTradeInputRevision(long value) { tradeInputRevision = value; }
    void setTemporalRevision(long value) { temporalRevision = value; }
