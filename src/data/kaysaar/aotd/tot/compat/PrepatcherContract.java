 ...
 *
 * <p>The class has no Starsector, Prepatcher or reflection dependency. The javaagent reads its
 * classfile marker and patches the fork-owned no-op bridge; no mod-side loader probing is
 * performed.
 */
public final class PrepatcherContract {
    ...
    public static final String FORK_VERSION = "1.0.14-spp12";
