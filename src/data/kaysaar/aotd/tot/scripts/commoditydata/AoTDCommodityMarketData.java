    ...
    public AoTDCommodityMarketData(String commodityId, String econGroup) {
        ...
        try (AoTDEconomySemanticBaseline.Scope ignored =
                AoTDEconomySemanticBaseline.begin(
                        "commodity-market-data.constructor", null, commodityId)) {
                ...
                if (commodityOnMarket instanceof AoTDCommodityOnMarket commodity) {
                    stockPile +=
                            Math.max(
                                    ...
                                    commodity.getSupplyDemandData().getTotalRawUnitsFromSupply());
                }
                if (stockPile > 0
                        && commodityOnMarket
                                instanceof AoTDCommodityOnMarket aoTDCommodityOnMarket) {
                    if (market.getId().equals("jangala")
                            && commodityId.equals(Commodities.SUPPLIES)) {
                        String he = "he";
                    }
                    AoTDAvailableStat var40 =
                            (AoTDAvailableStat) commodityOnMarket.getAvailableStat();
                    ...
                    for (String s : var40.getFlatMods().keySet()) {
                        ...
                        if (var40.getFlatStatMod(s).getValue() < 0) {
                            ...
                            aoTDCommodityOnMarket.setDef(
                                    aoTDCommodityOnMarket
                                            .getSupplyDemandData()
                                            .getEconSpec()
                    ...
                    int am =
                            aoTDCommodityOnMarket
                                    .getSupplyDemandData()
                                    .getAvailableOnThisMarket(stockPile, market, commodityId);
