package data.kaysaar.aotd.tot.produciton;
...
public final class AoTDProductionUIData {
    ...
    public static LinkedHashMap<String, Integer> getItemManInfo() {
        return itemManInfo;
    }
    ...
    public static LinkedHashMap<String, Integer> getWeaponSizeInfo() {
    ...
    public static LinkedHashMap<String, Integer> getWeaponManInfo() {
        return weaponManInfo;
    }

    public static LinkedHashMap<String, Integer> getFighterManInfo() {
    ...
    public static LinkedHashMap<String, Integer> getWeaponTypeInfo() {
        return weaponTypeInfo;
    }

    public static LinkedHashMap<String, Integer> getFighterTypeInfo() {
        return fighterTypeInfo;
    }

    // ----- routing getters -----

    public static LinkedHashMap<String, Integer> getManInfoBasedOnType(
        ...
        switch (type) {
            ...
            case SPECIAL_ITEM:
            case COMMODITY_ITEM:
                return itemManInfo; // grouped with special items in your logic
            default:
                return null;
        }
    }

    public static LinkedHashMap<String, Integer> getSizeInfoBasedOnType(
            AoTDProductionSpec.AoTDProductionSpecType type) {
        if (type == null) return null;
        switch (type) {
            case SHIP:
    ...
    public static LinkedHashMap<String, Integer> getTypeInfoBasedOnType(
            AoTDProductionSpec.AoTDProductionSpecType type) {
        if (type == null) return null;
        switch (type) {
            case SHIP:
    ...
    private static LinkedHashMap<String, Integer> countSpecs(
        ...
        List<AoTDProductionSpec> learned =
                AoTDProductionSpecManager.getLearnedSpecsForFaction(
    ...
    private static void finalizeAndStore(
        ...
        out.putAll(AshMisc.sortByValueDescending(counts));
    }
